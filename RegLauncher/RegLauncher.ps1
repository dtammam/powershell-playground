...
.DESCRIPTION
    The Set-LastKey function updates the 'LastKey' registry key in the path 'HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Applets\Regedit'. This key determines the default location that the Registry Editor (regedit) opens to. By setting this key, you can control the initial location that regedit navigates to upon opening.
